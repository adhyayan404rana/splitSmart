...
/* 3D Hollow Rotating Planet Word Cloud — Problems Solved by SplitSmart */
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="absolute inset-0 translate-x-4 translate-y-4 text-emerald-950/70 blur-xs">
            ₹
          </span>
          {/* 3D Depth Layer 2 (Emerald Extrusion) */}
          <span className="absolute inset-0 translate-x-2 translate-y-2 text-emerald-600/90">
            ₹
          </span>
          {/* Front Glowing Original 3D Green Neon Gradient Glyph */}
          <span className="relative bg-gradient-to-br from-emerald-300 via-emerald-400 to-teal-300 bg-clip-text text-transparent drop-shadow-[0_0_40px_rgba(52,211,153,0.95)] drop-shadow-[0_0_85px_rgba(16,185,129,0.8)]">
            ₹
          </span>
        </div>
      </motion.div>
...
export function LandingPage({
  ...
  const activeDemo = sampleExpenses[selectedDemo];
